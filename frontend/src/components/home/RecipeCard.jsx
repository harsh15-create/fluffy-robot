    ...
    >
      ...
      <Box p={4}>
        <Text fontSize={{ lg: "lg", md: "md", base: "sm" }} mb={"1rem"}>
            Some popular recipes globally and for home cooking include classics 
          like Pizza and Pasta dishes, along with well-loved international dishes
                       such as Chicken Curry, Tacos, and Biryani. 
        </Text>
        <Center my="2">
